...
public class ServerMessageHandling implements BasicMessageListener {
    private static final Logger logger = LogManager.getLogger(ServerMessageHandling.class);
    private final SpreadConnection connection;
    
    public ServerMessageHandling(SpreadConnection connection) {
